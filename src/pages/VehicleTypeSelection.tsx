...
const vehicles: Vehicle[] = [
  { id: "bike", name: "Bike Pool", desc: "Fast & single seat", eta: "2–4 min", icon: PiMotorcycleBold },
  { id: "auto", name: "Auto Share", desc: "Affordable shared rides", eta: "3–5 min", icon: AutoRickshawIcon },
  { id: "car", name: "Car Pool", desc: "Comfort & AC shared", eta: "4–6 min", icon: PiCarProfileBold },
  { id: "xl", name: "XL Pool", desc: "Group shared travel", eta: "5–8 min", icon: PiVanBold },
];
