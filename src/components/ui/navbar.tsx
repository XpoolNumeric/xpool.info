...
/* ─────────────────────────────────────────────────────────
   Login Button
───────────────────────────────────────────────────────── */
const LoginButton = ({ onLogin, fullWidth = false }: { onLogin: () => void; fullWidth?: boolean }) => {
  const [hovered, setHovered] = useState(false);
  return (
    <button
      onClick={onLogin}
      ...
      style={{
        ...
        border: `1.5px solid ${hovered ? "rgba(245, 158, 11, 0.5)" : "rgba(245, 158, 11, 0.2)"}`,
        color: "#f59e0b",
        fontFamily: "'DM Sans', sans-serif",
        fontWeight: 700,
        fontSize: "0.82rem",
          ...
          >
            ...
            >
              {profile ? (
                ...
                <>
                  <SupportButton />
                  <LoginButton onLogin={() => setShowAuthDialog(true)} />
                  <DownloadButton />
                </>
              )}
            </div>
        ...
        >
          {profile ? (
            ...
            <>
              ...
              <LoginButton onLogin={() => { setIsOpen(false); setShowAuthDialog(true); }} fullWidth />
